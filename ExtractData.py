...
def ExtractData(filepath):
    ...
    Invoice__IssueDate, Invoice__Number, Bussiness__Zipcode, Bussiness__Country, Bussiness__City, Bussiness__StreetAddress = getInvoiceAndBussinessDetails(
        BussinessNameid)
    Invoice__Description, Invoice__DueDate, Customer__PhoneNumber, Customer__Name, Customer__Email, Customer__Address__line1, Customer__Address__line2, tablebegin = getCustomerAndInvoiceDetails(
        Bussiness__Descriptionid)
    Invoice__BillDetails__Rate, Invoice__BillDetails__Quantity, Invoice__BillDetails__Name = getTableDetails(tablebegin,
                                                                                                             Invoice__Taxid)
    dataoutput= []
    for rows in range(len(Invoice__BillDetails__Name)):
        dataoutput.append(
            [Bussiness__City, Bussiness__Country, Bussiness__Description, Bussiness__Name, Bussiness__StreetAddress,
             Bussiness__Zipcode, Customer__Address__line1, Customer__Address__line2, Customer__Email, Customer__Name,
             Customer__PhoneNumber, Invoice__BillDetails__Name[rows], Invoice__BillDetails__Quantity[rows],
             Invoice__BillDetails__Rate[rows], Invoice__Description, Invoice__DueDate, Invoice__IssueDate,
